...
let UserService = class UserService {
    ...
    VerifyUser(event) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, response_1.SuccessResponse)({ message: "response from verity user" });
        });
    }
    // User profile
    CreateProfile(event) {
    ...
    UpdateCart(event) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, response_1.SuccessResponse)({ message: "response from edit cart" });
        });
    }
    // Payment Section
    ...
    UpdatePaymentMethod(event) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, response_1.SuccessResponse)({ message: "response from edit payment method" });
        });
    }
};
